...
class vehicle_external_command:
    ...
    def pos_cb(self, msg: PoseStamped):
        ...
        self.attitude[0] = (P + self.init_P) * 180 / PI
        self.attitude[1] = (R + self.init_R) * 180 / PI
        self.attitude[2] = (Y + self.init_Y) * 180 / PI
    ...
    def vel_cb(self, msg: TwistStamped):
        ...
        self.angle_rate[0] = msg.twist.angular.x * 180 / PI
        self.angle_rate[1] = msg.twist.angular.y * 180 / PI
        self.angle_rate[2] = msg.twist.angular.z * 180 / PI
