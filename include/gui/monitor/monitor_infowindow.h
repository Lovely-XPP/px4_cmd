#ifndef MONITORINFOWINDOW_H
#define MONITORINFOWINDOW_H
#include <QDialog>
#include <QLineEdit>
#include <QPushButton>
#include <QVBoxLayout>
...
class MonitorInfoWindow : public QWidget
{
    ...
    private:
        ...
        void setup()
        {
            ...
            QObject::connect(topic_name_info_button, &QPushButton::clicked, this, &MonitorInfoWindow::topic_name_info_slot);
            QObject::connect(sensors_info_button, &QPushButton::clicked, this, &MonitorInfoWindow::sensors_info_slot);
        }
